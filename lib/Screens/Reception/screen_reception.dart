...
class ScreenReception extends StatelessWidget {
  ...
  ScreenReception(bool IsRigester,BuildContext context,String NewName,String CodeNew){
    ...
    Notifi.ListItemsPatient.add(ModelPatient(id: 7445, fullName: 'NimaMorado', nationalCode: '1788484', age: '32', gender: 'مرد', timeOfAddToSystem: '', dateOfAddToSystem: '', needToMRI: false, isNot724: false, needToCT: false, IsNIHSS: false, IsLab: false));

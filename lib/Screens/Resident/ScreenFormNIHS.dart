...
class ScreenFormNIHS extends StatefulWidget {
  ...
  ScreenFormNIHS(
      ...
      this.isAtend,
      this.subscroe
      ); // ScreenFormNIHS(this.onClose,this.ISEdit,this.DataEdit);
...
class _ExamFormState extends State<ScreenFormNIHS> {
  ...
  Future  checkData()async{
    ...
    questions.add(QuestionAnswer(
        ...
        correctIndex: 0,
        selectedAnswer: widget.ISEdit ? n_1_aNumber : 0));
    ...
    questions.add(QuestionAnswer(
        ...
        correctIndex: 0,
        selectedAnswer: widget.ISEdit ? n_1_bNumber : 0));
    ...
    questions.add(QuestionAnswer(
        ...
        correctIndex: 0,
        selectedAnswer: widget.ISEdit ? n_1_cNumber : 0));

    questions.add(QuestionAnswer(
        question: 'Best Gaze',
        options: ['Normal', 'Partial gaze palsy', 'Forced deviation'],
        correctIndex: 0,
        selectedAnswer: widget.ISEdit ? n_2Number : 0));
    ...
    questions.add(QuestionAnswer(
        ...
        correctIndex: 0,
        selectedAnswer: widget.ISEdit ? n_3Number : 0));
    ...
    questions.add(QuestionAnswer(
        ...
        correctIndex: 0,
        selectedAnswer: widget.ISEdit ? n_4Number : 0));
    ...
    questions.add(QuestionAnswer(
        ...
        correctIndex: 0,
        selectedAnswer: widget.ISEdit ? n_5_aNumber : 0));
    ...
    questions.add(QuestionAnswer(
        ...
        correctIndex: 0,
        selectedAnswer: widget.ISEdit ? n_5_bNumber : 0));
    ...
    questions.add(QuestionAnswer(
        ...
        correctIndex: 0,
        selectedAnswer: widget.ISEdit ? n_6_aNumber : 0));
    ...
    questions.add(QuestionAnswer(
        ...
        correctIndex: 0,
        selectedAnswer: widget.ISEdit ? n_6_bNumber : 0));
    //
    ...
    questions.add(QuestionAnswer(
        ...
        correctIndex: 0,
        selectedAnswer: widget.ISEdit ? n_7Number : 0));
    ...
    questions.add(QuestionAnswer(
        ...
        correctIndex: 0,
        selectedAnswer: widget.ISEdit ? n_8Number : 0));
    questions.add(QuestionAnswer(
        ...
        correctIndex: 0,
        selectedAnswer: widget.ISEdit ? n_9Number : 0));

    questions.add(QuestionAnswer(
        question: 'Dysarthria',
        options: ['No aphasia', 'Mild-to-moderate aphasia', 'Severe aphasia'],
        correctIndex: 0,
        selectedAnswer: widget.ISEdit ? n_10Number : 0));
                                ...
                                child: Row(
                                  children: [
                                    Padding(
                                      ...
                                      child: TextAppfredoka(
                                          'NIHSS', 16, Colors.white, true),
                                    ),
                                    Spacer(),
                                    Padding(
                                      padding: const EdgeInsets.symmetric(
